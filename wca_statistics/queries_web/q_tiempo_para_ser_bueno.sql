...
select
    time_range
    , avg(total_competiciones) as avg_total_round
    , avg(competiciones_hasta_record) as avg_number_round_to_record
    , avg(avg_hasta_record) as avg_times_before_record
    , avg(competiciones_despues_record) as avg_number_of_rounds_after_record
